...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form action="{{ url('appointments') }}" method="post">
            ...
            <input type="text" name="description" value="{{ old('description') }}" id="description" class="form-control" placeholder="Describe brevemente la consulta" required>
            </div>
            <div class="form-row">
                ...
                <div class="form-group- col-md-6">
                    ...
                    <select name="doctor_id" id="doctor" class="form-control" required>
                        ...
                        <option value="{{ $doctor->id }}" @if(old('doctor_id') == $doctor->id) selected @endif>{{ $doctor->name}} {{ $doctor->last_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control datepicker" placeholder="Seleccionar fecha" id="date" name="scheduled_date" type="text" 
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio mb-3">
                    ...
                    @if(old('type') == 'Limpieza') checked @endif value="Limpieza">
                    <label class="custom-control-label" for="type2">Limpieza dental</label>
                </div>
                <div class="custom-control custom-radio mb-3">
                    <input name="type" class="custom-control-input" id="type3" type="radio"
                    @if(old('type') == 'Vacunación') checked @endif value="Vacunación">
                    <label class="custom-control-label" for="type3">Vacunación</label>
                </div>
                <div class="custom-control custom-radio mb-3">
                    <input name="type" class="custom-control-input" id="type4" type="radio"
                    @if(old('type') == 'Exámen') checked @endif value="Exámen">
                    <label class="custom-control-label" for="type4">Exámen</label>
                </div>
            </div>
