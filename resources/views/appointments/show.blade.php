...
@section('content')
    ...
    <div class="card-body">
        <ul>
            ...
            <li>
                <strong>Médico: </strong> {{ $appointment->doctor->name }} {{ $appointment->doctor->last_name }}
            </li>
            @endif 

            @if ($role == 'doctor' || $role == 'admin')
            <li>
                <strong>Paciente: </strong> {{ $appointment->patient->name }} {{ $appointment->patient->last_name }}
            </li>
            @endif
        ...
        @if ($appointment->status == 'Cancelada')
            ...
            <div class="alert alert-warning">
                ...
                <li>
                    ...
                    Tú
                    @else
                    {{ $appointment->cancellation->cancelled_by->name }} {{ $appointment->cancellation->cancelled_by->last_name }}
                    @endif
                    </li>
                    <li>
                ...
                @else
                    <li>
                        Esta cita fue cancelada antes de su confirmación.
                    </li>
                @endif
                </ul>
            </div>
